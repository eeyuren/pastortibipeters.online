...
<main class="main_content">
	<div class="container-fluid mt-5">
		<div class="row">
			<div class="col-md-12">
				<h3 class="fw-bold" align="center">BELIEVERS CORE TEACHING MESSAGES</h3>
			</div>
		</div>
		<div class="row mt-5" align="center">
			<div class="col-md-4">
				<div class="card" style="width: 100%; height:100%;">
				  <img class="card-img-top" src="asset/img/prayer.webp" width="100%">
				  <div class="card-body">
			...
			<div class="col-md-4">
				<div class="card" style="width: 100%; height:100%;">
				  <img class="card-img-top" src="asset/img/worship.jpg" width="100%">
				  <div class="card-body">
				    <h6 class="card-title fw-bold">
			...
			<div class="col-md-4">
				<div class="card" style="width: 100%;height:100%;">
				  <img class="card-img-top" src="asset/img/discipleship.jpg" width="100%">
				  <div class="card-body">
				    <h6 class="card-title fw-bold">
		...
		<div class="row mt-5" align="center">
			<div class="col-md-4">
				<div class="card" style="width: 100%; height:100%;">
				  <img class="card-img-top" src="asset/img/service.jpg" width="100%">
				  <div class="card-body">
				    <h6 class="card-title fw-bold">
			...
			<div class="col-md-4">
				<div class="card" style="width: 100%; height:100%;">
				  <img class="card-img-top" src="asset/img/giving.webp" width="100%" height="220">
				  <div class="card-body">
				    <h6 class="card-title fw-bold">
			...
			<div class="col-md-4">
				<div class="card" style="width: 100%;height:100%;">
				  <img class="card-img-top" src="asset/img/evangelism.jpeg" width="100%">
				  <div class="card-body">
				    <h6 class="card-title fw-bold">
