<?php 
	...
	if (isset($_POST['subscription_btn'])){
		...
		if ($complete==1) {
			...
			$db->query("INSERT INTO video_subscription(user_id, media_id, subscription_duration, subscription_access, subscription_date)VALUES('$uid','$media_id','$subscription_duration','$subscription_access','$subscription_date')");
