...
<?php  
    ...
    $classic_cat=$db->query("SELECT  classic_sub_cat FROM category");
    $believers_cat=$db->query("SELECT  believers_core_sub_cat FROM category");
    $faith_food=$db->query("SELECT  faith_food_sub_cat FROM category");
?>
        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="float-right">
                    ...
                    <a href="view_pdf.php" class="btn btn-secondary fw-bold btn-sm mt-2">
                        <i class="fas fa-eye"></i> View PDF Upload
                    </a>
                </div>
              <!--   <div class="float-right mb-4">
                ...
                <div align="center">
                 ...
                 <?php require_once  "../error_msg.php"; ?>
                    <form action="../library/media_pdf_upload_action.php"method="POST"enctype="multipart/form-data" class="audio_form">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select class="form-control" name="pdf_category" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pdf" value="PDF" readonly class="form-control">
                        </div>
                        <div class="form-group mt-3">
                            <label class="fw-bold" for="audio">Upload PDF File</label>
                        ...
                        <div class="form-group">
                            <input type="submit" class="mt-2 btn fw-bold btn-warning" value="Upload PDF File" name="btn_upload_pdf_files" id="upload_files"><br><br>
                        </div>     
                    </form>
